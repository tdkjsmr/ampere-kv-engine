...
def main():
    ...
    if args.engine == "ampere":
        samples, engine_config, warmup_outputs = run_ampere(prompts, args.batch, output_tokens, repeats)
    else:
    ...
    result = {
        ...
        "timing": ("warmup_only_no_measurement" if args.evidence_only
                   else "warmup_excluded_wall_submit_to_all_host_ids_ready"),
